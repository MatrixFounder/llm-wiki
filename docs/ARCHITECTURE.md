...
> files).** Deferred (tracked in `docs/issues/`):
...
> were later **FIXED** — TASK 013 / 014; **R-X1-REDOS-RT** runtime regex deadline + **P-2** + **P-3**
> **FIXED** — TASK 017, see §3.5/§8.4.) Replaces ~15 hardcoded layout surfaces
