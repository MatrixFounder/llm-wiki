...
- **Acceptance:** ✅ round-trip byte-identical (modulo GENERATED-AT). ✅ `wiki-search "hash drift" --types known-issue` returns one issue. ✅ `wiki-lint` flags a hand-edit of the generated ledger.
