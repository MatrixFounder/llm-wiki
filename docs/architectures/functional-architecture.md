...
| **2.2** | **Native-App Control Skill** (`obsidian-cli`, TASK 029) — routing / coherence / safety / degradation invariants + **active-note resolution** (§2.2.1, TASK 041 / ADR-008) + **editor-selection bridge** (§2.2.2, TASK 068) | [functional/native-app-control.md](./functional/native-app-control.md) |
