...
| **Effort** | P0-P3 ≈ **4.5-5 d** (15 beads — see [PLAN.md](../plans/plan-072-r7-wiki-research-refutation-and-split.md); P1b re-estimated **1.5-2.0 d** at plan-review, plus **072-04 in a second repository** and **072-10b** added by the OQ-4 ruling) · P4-P5 ≈ **2 d, CONDITIONAL** on the P3 dogfood |
