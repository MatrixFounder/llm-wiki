...
# Moved to the neutral leaf `scripts/wiki_skills/_active_note.py` (TASK 058)
# so wiki-config can share the signal without a skill→skill import
# (Decision-16). Re-exported here verbatim (`as` = explicit re-export for
# mypy strict) — the wiki-import surface and the TASK 057-06 tests are
# unchanged.
from scripts.wiki_skills._active_note import (  # noqa: E402
    active_note_folder as active_note_folder,
)
